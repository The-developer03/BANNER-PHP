<?php 
 ...
 $des = array("\n\033[94m\033[01m   █████╗ ██████╗ ██╗   ██╗ █████╗ ███╗   ██╗ ██████╗███████╗", 
        ...
        "\n\033[39m      ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝", 
        "\n\t\t\t\t\t\t\033[93m    php", 
        "\n\n\t\033[01m\033[32m    [+] CODED BY THE DEVELOPER\n", 
        "\t\033[32m    [+] 👑 OWNER OF ERROR 404\n\n"); 
 foreach ($des as $de){ 
         print $de; 
         usleep(20000); 
         } 
 ...
 elseif ( $a == 3 ){ 
         logo(); 
         $about = array("\n\033[44m\033[39m THE DEVELOPER\033[49m\n\n", 
               "\n\033[93m\t     \033[40mCODED BY THE DEVELOPER \033[49m\n", 
               "\n\033[93m\t     \033[40mBY THE DEVELOPER OFC\033[49m\n", 
               "\n\033[93m\t     \033[40mBY:\033[49m\n", 
               "\033[93m\t\t     \033[40mTHE DEVELOPER OFC\033[49m\n", 
               "\n\033[93m\t     \033[40mJoin us:\033[49m\n", 
               "\033[93m\t\t     \033[40mTelegram: https://t.me/the_developer01\033[49m\n\n\n", 
 ...
 elseif ( $a == 4 ){ 
         ...
         if ( $jc == 1 ){ 
                 system("xdg-open https://github.com/thedeveloper03"); 
                 sleep(5); 
                 logo(); 
                 menu(); 
                 } 
